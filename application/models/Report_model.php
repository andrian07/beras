...
class report_model extends CI_Model {
     ...
     protected $table_header_sales = 'tbl_header_sales';
   ...
   /* public function get_reportstock($warehouse){
    ...
    public function get_reporthutang(){
    	$query = $this->db->query("select * from tbl_header_sales a, tbl_customer b where a.sales_customer_id = b.customer_id and a.sales_status = 'hutang' and sales_date > '2023-12-31'");
    	$result = $query->result();
        return $result;
    }

    public function get_reporthutang_byduedate($datefrom, $dateend, $customersales, $salesid){

    	if($datefrom == '' && $customersales == '' && $salesid == ''){
    	...
    	}else if($customersales == '' && $salesid == ''){
    	$query = $this->db->query("select * from tbl_header_sales a, tbl_customer b where a.sales_customer_id = b.customer_id and a.sales_status = 'hutang' and sales_date between '".$datefrom."' and '".$dateend."'");
    	}else if($salesid == ''){
        $query = $this->db->query("select * from tbl_header_sales a, tbl_customer b where a.sales_customer_id = b.customer_id and a.sales_status = 'hutang' and sales_customer_id = '".$customersales."' and sales_date between '".$datefrom."' and '".$dateend."'");
        }else if($customersales == ''){
    	$query = $this->db->query("select * from tbl_header_sales a, tbl_customer b where a.sales_customer_id = b.customer_id and a.sales_status = 'hutang' and sales_sales_name = '".$salesid."' and sales_date between '".$datefrom."' and '".$dateend."'");
    	}else{
            $query = $this->db->query("select * from tbl_header_sales a, tbl_customer b where a.sales_customer_id = b.customer_id and a.sales_status = 'hutang' and sales_sales_name = '".$salesid."' and sales_customer_id = '".$customersales."' and sales_date between '".$datefrom."' and '".$dateend."'");
        }
    	$result = $query->result();
        return $result;
    }
    ...
    public function get_reportpiutang_byduedate($datefrom, $dateend, $suplierpurchase){
    	...
    	$query = $this->db->query("select * from tbl_header_purchase a, tbl_mastersuplier b where a.purchase_suplier_id = b.suplier_id and a.purchase_status = 'hutang' and purchase_date between '".$datefrom."' and '".$dateend."'");
    	}else{
    	$query = $this->db->query("select * from tbl_header_purchase a, tbl_mastersuplier b where a.purchase_suplier_id = b.suplier_id and a.purchase_status = 'hutang' and purchase_suplier_id = '".$suplierpurchase."' and purchase_date between '".$datefrom."' and '".$dateend."'");
    	}
    	$result = $query->result();
        return $result;
    }
    ...
    public function get_reportpiutang(){
    	$query = $this->db->query("select * from tbl_header_purchase a, tbl_mastersuplier b where a.purchase_suplier_id = b.suplier_id and a.purchase_status = 'hutang' and purchase_date > '2023-12-31'");
    	$result = $query->result();
        return $result;
    }

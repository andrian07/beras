...
class retur_model extends CI_Model {
    ...
    public function get_header_faktur(){
      ...
      public function get_salesheader_retur(){
        $query = $this->db->query("select * from tbl_header_sales where sales_date > '2024-06-01'");
        $result = $query->result();
        return $result;
    }
    ...
    public function check_retur_cart($retursalesitem, $retursalesid){
        $query = $this->db->query("select * from tbl_detail_retur_sales_cart where retur_sales_cart_item = '".$retursalesitem."' and retur_sales_cart_inv = '".$retursalesid."'");
        $result = $query->result();
        return $result;
    }

    public function check_retur_item($retursalesitem, $retursalesfakturid)
    {
         $query = $this->db->query("select * from tbl_detail_retur_sales where retur_sales_item = '".$retursalesitem."' and retur_sales_transaction = '".$retursalesfakturid."'");
        $result = $query->result();
        return $result;
    }
